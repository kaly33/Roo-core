...
public class GlobalVariable {
    ...
    static {
        ...
        allVariables.put('Dev environment', allVariables['default'] + ['AdminEmail' : 'kkachhi+admin@roostify.com', 'Password' : 'Kal@3333', 'AdminFirstName' : 'Kalyani', 'AdminLastName' : 'Admin', 'BaseURL' : 'https://test.roostify.com', 'BorrowerEmail1' : 'kkachhi+test5@roostify.com', 'BorrowerEmail2' : 'kkachhi+test1@roostify.com', 'BorrowerEmail3' : 'kkachhi+test4@roostify.com', 'Borrower1FirstName' : 'Kaly1', 'Borrower1LastName' : 'Kachhi', 'Borrower2FirstName' : 'Kaly2', 'Borrower2LastName' : 'Kachhi', 'Borrower3FirstName' : 'Kaly3', 'Borrower3LastName' : 'Kachhi'])
        allVariables.put('QA environment', allVariables['default'] + ['AdminEmail' : 'kkachhi+admin@roostify.com', 'Password' : 'Kal@3333', 'AdminFirstName' : 'Kalyani', 'AdminLastName' : 'Admin', 'BaseURL' : 'https://roostify-blueprint-dev.herokuapp.com/users/sign_in?a=blueprintdev', 'BorrowerEmail1' : 'kkachhi+test30@roostify.com', 'BorrowerEmail2' : 'kkachhi+test31@roostify.com', 'BorrowerEmail3' : 'kkachhi+test32@roostify.com', 'Borrower1FirstName' : 'Kaly1', 'Borrower1LastName' : 'Kachhi', 'Borrower2FirstName' : 'Kaly2', 'Borrower2LastName' : 'Kachhi', 'Borrower3FirstName' : 'Kaly3', 'Borrower3LastName' : 'Kachhi'])
