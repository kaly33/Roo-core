...
WebUI.callTestCase(findTestCase('Sign In'), [('email') : GlobalVariable.BorrowerEmail2, ('password') : GlobalVariable.Password], FailureHandling.STOP_ON_FAILURE)
/*Borrower Details*/
...
//WebUI.click(findTestObject('Complete Loan Details/Borrower Details/button_Next'))
//WebUI.click(findTestObject('Complete Loan Details/Borrower Details/button_Fix later and continue'))

/*Loan Details*/
/*WebUI.click(findTestObject('Complete Loan Details/Loan Details/button_Next'))
WebUI.waitForPageLoad(10)
WebUI.click(findTestObject('Complete Loan Details/Loan Details/input_pre_approval_checkbox'))
WebUI.click(findTestObject('Complete Loan Details/Loan Details/button_Next'))
WebUI.waitForPageLoad(10)
WebUI.setText(findTestObject('Complete Loan Details/Loan Details/input_Down Payment Percentage'),'5')
WebUI.click(findTestObject('Complete Loan Details/Loan Details/button_Next'))
WebUI.waitForPageLoad(10)
WebUI.click(findTestObject('Complete Loan Details/Loan Details/select_Type_of_loan'))
WebUI.click(findTestObject('Complete Loan Details/Loan Details/button_Next'))
WebUI.waitForPageLoad(10)
WebUI.click(findTestObject('Complete Loan Details/Loan Details/select_Down_payment_method_1'))
WebUI.click(findTestObject('Complete Loan Details/Loan Details/button_Next'))*/
