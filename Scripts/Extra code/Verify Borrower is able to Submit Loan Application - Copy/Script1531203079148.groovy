...
WebUI.selectOptionByValue(findTestObject('Loan Pages/Borrower Details/select_Month_Starting_from'), '9', true)

WebUI.selectOptionByValue(findTestObject('Loan Pages/Borrower Details/select_Year_Starting_from'), '2016', true)
...
WebUI.setText(findTestObject('null'), '333')

WebUI.setText(findTestObject('null'), '33')

WebUI.setText(findTestObject('null'), '3333')
