...
WebUI.callTestCase(findTestCase('Admin Dashboard/Verify Admin is able to Create Loan Manually'), [('Email') : GlobalVariable.BorrowerEmail3,('FirstName') : GlobalVariable.Borrower3FirstName, ('LastName') : GlobalVariable.Borrower3LastName], FailureHandling.STOP_ON_FAILURE)
